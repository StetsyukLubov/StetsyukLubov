 ...
 ***Важно запомнить команду I+esc 
 :wq*** - это  наша  палочка - выручалочка, если экран засит, и строка git не активна.
...
для слияния выбранной ветки с текущей нужно выполнитьь команду
``` git merge "Название выбранной ветки"```
Если была изменена одна и та же часть файлав  обеих папках, то может возникнуть конфликт.
...
Важно помнить, что не возможно удалить папку, находясь на  той же ветке. Для удаления необходимо перейти в другую папку, напрмиер, ***master*** , и  выполнить удаление, указав имя ветки.
